...
[MOZ](https://developer.mozilla.org/zh-CN/docs/Learn/JavaScript/Objects/Basics#对象基础)
...
[MOZ](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Functions)
...
[MOZ](https://developer.mozilla.org/zh-CN/docs/Learn/JavaScript/Objects/Object-oriented_JS#构建函数和对象)
...
[MOZ](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/new)
...
![prototype_chain_1](./static/prototype_chain_1.png)
...
![prototype_chain_2](./static/prototype_chain_2.png)
...
在记忆上，只要了解上文中阐述的 `prototype` 与 `__proto__` 产生的时机，就能方便的区分开来了。一般的，对于用户级的代码：
 ...
 在此基础上，在之后的文章中，我们便可以清晰的讨论原型链的问题了。